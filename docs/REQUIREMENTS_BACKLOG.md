...
| Admin | REQ-ADM-002 | 공연장 좌석/구역 기준정보 등록 | venue 기준 `seats`, `sections`를 생성하고 구역별 판매 타입을 관리한다 | P0 | 구현완료 | `ASSIGNED_SEAT`, `GENERAL_ADMISSION` |
| Admin | REQ-ADM-003 | 회차 판매 인벤토리 생성 | show 기준 타입에 맞춰 `show_seats`, `show_section_inventories`를 생성한다 | P0 | 구현완료 | 타입 불일치 요청은 400 |
